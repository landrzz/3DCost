...
using Landers.ThreeDCost.Services;
using Landers.ThreeDCost.Views;
...
using DebugLogger = Landers.ThreeDCost.Services.DebugLogger;
using Landers.ThreeDCost.ViewModels;

namespace Landers.ThreeDCost
{
    public partial class App : PrismApplication
    {
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterForNavigation<CalculatePage, CalculatePageViewModel>();
